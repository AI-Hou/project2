...
def concate_feature(data):
    features=[('user_occupation_id','shop_star_level'),('item_collected_level','item_pv_level'),
              ('user_star_level','hour48'),('item_price_level','hour48'),('item_sales_level','context_page_id')]
    con_fea=[]
